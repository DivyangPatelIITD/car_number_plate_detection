# -*- coding: utf-8 -*-
"""
Created on Sat Dec 11 14:40:18 2021
...
def list_of_charac(image) :
    ...
    #erode and dialate makes image sharp
...
img = cv2.imread('C:/IIITD_Sem_3/Digital_image_processing/project/Final_images_cropped/CarLongPlate315.jpg')#CarLongPlate47 (1).jpg')
...
#img=
"""
my_img=(char[6]*255).astype(int)
img_2 = Image.fromarray(my_img)
img_2.save('img8_2.png')
#"""
